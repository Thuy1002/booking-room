...
@endsection
@section('content')
    <section style="padding-bottom:120px ;padding-top: 0px;" class="accomodation_area section_gap">
        <!-- fillter -->
        <div class="hotel_booking_area position">
            <div class="">
                <div style="margin-bottom: 30px;" class="hotel_booking_table">
                    <div class="col-md-3">
        ...
        <!-- end fillter -->
        <div class="container">
            <div style=" margin-bottom:50px; " class="section_title text-center">
            ...
            <div class="row mb_30">
                <div class="col-lg-3 col-sm-6">
                    <div class="accomodation_item text-center">
                        <div class="hotel_img">
                            <img src="{{ asset('client/image/room4.jpg')}}" alt="">
                            <a style="border-radius: 10px;" href="#" class="btn theme_btn button_hover">Book Now</a>
                        </div>
                        <a href="#">
                ...
                <div class="col-md-6 d_flex align-items-center">
                    <div class="about_content ">
                        ...
                        <p>inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct
                            ...
                            the job is beyond reproach. inappropriate
                            behavior is often laughed.</p>
                        <a href="#" class="button_hover theme_btn_two">Request Custom Price</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('client/image/about_bg.jpg')}}" alt="img">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="testimonial_slider owl-carousel">
                <div class="media testimonial_item">
                    <img class="rounded-circle" src="{{ asset('client/image/testtimonial-1.jpg')}}" alt="">
            ...
            <div class="row mb_30">
                <div class="col-lg-4 col-md-6">
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="{{ asset('client/image/blog/blog-1.jpg')}}" alt="post">
                        </div>
                        <div class="details">
                            <div class="tags">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="{{ asset('client/image/blog/blog-2.jpg')}}" alt="post">
                        </div>
                        <div class="details">
                            <div class="tags">
                                <a href="#" class="button_hover tag_btn">Travel</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="{{ asset('client/image/blog/blog-3.jpg')}}" alt="post">
                        </div>
                        <div class="details">
                            <div class="tags">
                                <a href="#" class="button_hover tag_btn">Travel</a>
