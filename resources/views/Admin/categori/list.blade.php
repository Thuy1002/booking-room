...
@section('content')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--end::Dropdown-->
                            <!--begin::Button-->
                            <a href="{{ route('admin.categori.add') }}" class="btn btn-primary font-weight-bolder">
                                <span class="svg-icon svg-icon-md">
                            ...
                            <tbody id="product-list">
                                @foreach ($cate as $item)
                                    <tr>
                                        ...
                                        <td><img style="width:150px;border-radius:10px" src="{{ asset('storage/' . $item->image) }}" alt=""></td>
                                        <td>{{ $item->title }}</td>
                                        <td> {{ $item->content }}</td>
                                        <td>
                                            <div class="col-3">
                                                <span class="switch switch-outline switch-icon switch-primary">
                                                    <label>
                                                        <input class="doikieu" type="checkbox"
                                                            ...
                                                            data-url="{{ route('admin.categori.change', $item->id) }}" />
                                                        <span></span>
                                                    </label>
                                                </span>
                                            </div>
                                        ...
                                        <td style="display:flex ">
                                            <a href="{{ route('admin.categori.update', $item->id) }}"
                                            ...
                                            <a onclick="if (confirm('Bạn có muốn xóa không ?')) { window.location.href = '{{ route('admin.categori.delete', $item->id) }}'; }"
    ...
    <script>
        $(document).ready(function() {
            ...
            //     $.ajax({
            //         url: '{{ route('admin.categori.fillersStt') }}',
            //         type: 'GET',
            //         data: {
            //             status: stt
            //         },
