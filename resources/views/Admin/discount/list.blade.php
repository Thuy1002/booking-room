        ...
        <div style="margin:auto;" class="col-xl-10">
            <div style="display: flex;margin-bottom:20px ;justify-content: space-between;"
                ...
                <div class="card-toolbar">
                    ...
                    <!--end::Dropdown-->
                    <!--begin::Button-->
                    <a href="{{ route('admin.discount.add') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                        ...
                        <div class="tab-pane fade active show" id="kt_tab_pane_4_1" role="tabpanel"
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless table-vertical-center">
                                    <thead>
                                        <tr style="tex">
                                            <th  style="text-align: center;" class="p-0 w-50px">#</th>
                                            <th class="p-0 min-w-150px"></th>
                                            <th  style="text-align: center;" class="p-0 min-w-140px">Satus</th>
                                            <th  style="text-align: center;" class="p-0 min-w-120px">Time</th>
                                            <th  style="text-align: center;" class="p-0 min-w-70px">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($discount as $item)
                                            <tr>
                                                <td class="pl-0">
                                                    <div class="symbol symbol-50 symbol-light mt-2 mr-2">
                                                        <span style=" width: 90px; height: 74px;" class="symbol-label">
                                                            <img style="border-radius:5px; width: 90px; height: 74px;"
                                                ...
                                                <td  style="text-align: center;">
                                                    ...
                                                    <div class="col-3">
                                                        <span class="switch switch-outline switch-icon switch-primary">
                                                            <label style="    margin-left: 63px;">
                                                                <input class="doikieu" type="checkbox"
                                                                    {{ $item->status == 1 ? 'checked' : '' }}
                                                                    data-discount-id="{{ $item->id }}"
                                                                    data-url="{{ route('admin.discount.change', $item->id) }}" />
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
                                                ...
                                                <td  style="text-align: center;" class="text-right">
                                                    <a  href="{{ route('admin.discount.update', $item->id) }}"
                                                    ...
                                                    <a onclick="if (confirm('Bạn có muốn xóa không ?')) { window.location.href = '{{ route('admin.discount.delete', $item->id) }}'; }"
